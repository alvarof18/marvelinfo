...
fun MarvelInfoNav(
    ...
    NavHost(
      ...
      //  exitTransition = { ExitTransition.None }
        ...
        composable(route = Routes.FavoriteComics.route){ FavoriteComicScreen(comicViewModel = viewModelComic,navController = navController )}
        composable(route = Routes.Characters.route) { CharactersScreen() }
        composable(route = Routes.SearchComic.route) { SearchScreen() }
